...
const response = await fetch(`${baseUrl}/api/experiments/v14-acceptance`, {
  method: "POST",
  headers: {
...
if (!response.ok || !payload.receipt) {
  throw new Error(payload.error || `v1.4 acceptance returned HTTP ${response.status}.`);
}

const evidence = {
  schemaVersion: "experiments.v14-acceptance-runner-evidence.v1",
