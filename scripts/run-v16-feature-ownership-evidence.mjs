...
const response = await fetch(
  `${baseUrl}/api/experiments/v16-feature-ownership`,
  {
    method: "POST",
    headers: {
...
if (!response.ok || !payload.receipt) {
  throw new Error(
    payload.error || `v1.6 acceptance returned HTTP ${response.status}.`,
  );
}

const evidence = {
  schemaVersion: "experiments.v16-feature-ownership-runner-evidence.v1",
