...
check_json_field "V3.0.0-v3.0.9 remediation control train" "$BASE_URL/api/experiments/remediation-control" "data.ok===true && data.schemaVersion==='experiments.remediation-control-train.v1' && data.sourceStatus==='pass' && ['pass','attention'].includes(data.localStatus) && data.externalStatus==='hold' && data.productionStatus==='blocked' && data.sourceSummary && data.sourceSummary.sourceOwnedSignals===9 && data.summary && data.summary.requiredVersions===10 && data.remediationControlPlane && data.remediationControlPlane.summary.totalItems===15 && data.remediationControlPlane.checks.dependencyGraphAcyclic===true && Array.isArray(data.versions) && data.versions.length===10 && data.versions.every((item)=>item.sourceSignal && ['pass','attention','unavailable','external-only'].includes(item.sourceSignal.status) && ['missing','invalid','verified'].includes(item.evidenceStatus) && item.checks.localProductionTransitionDenied===true)"
check_json_field "V3.1.0-v3.1.4 service readiness train" "$BASE_URL/api/experiments/service-readiness" "data.ok===true && data.schemaVersion==='experiments.service-readiness-train.v1' && data.sourceStatus==='pass' && ['pass','attention'].includes(data.localStatus) && data.externalStatus==='hold' && data.productionStatus==='blocked' && data.sourceSummary && data.sourceSummary.sourceOwnedSignals===4 && data.summary && data.summary.requiredVersions===5 && data.remediationControlPlane && data.remediationControlPlane.productionStatus==='blocked' && Array.isArray(data.versions) && data.versions.length===5 && data.versions.every((item)=>item.sourceSignal && ['pass','attention','unavailable','external-only'].includes(item.sourceSignal.status) && ['missing','invalid','verified'].includes(item.evidenceStatus) && item.checks.localProductionTransitionDenied===true)"
check_json_field "V3.2.0-v3.2.9 remediation execution train" "$BASE_URL/api/experiments/remediation-execution" "data.ok===true && data.schemaVersion==='experiments.remediation-execution-train.v1' && data.sourceStatus==='pass' && ['pass','attention'].includes(data.localStatus) && data.externalStatus==='hold' && data.productionStatus==='blocked' && data.sourceSummary && data.sourceSummary.sourceOwnedSignals===9 && data.summary && data.summary.requiredVersions===10 && data.remediationExecutionPlan && data.remediationExecutionPlan.schemaVersion==='experiments.remediation-execution-plan.v1' && data.remediationExecutionPlan.summary.totalActions===7 && data.remediationExecutionPlan.checks.everyActionHasIdempotencyKey===true && data.remediationExecutionPlan.checks.everyActionHasLeaseAndFence===true && data.remediationExecutionPlan.checks.everyActionHasRollback===true && data.remediationExecutionPlan.checks.remoteMutationDenied===true && data.remediationExecutionPlan.productionStatus==='blocked' && Array.isArray(data.versions) && data.versions.length===10 && data.versions.every((item)=>item.sourceSignal && ['pass','attention','unavailable','external-only'].includes(item.sourceSignal.status) && ['missing','invalid','verified'].includes(item.evidenceStatus) && item.checks.localProductionTransitionDenied===true)"
check_json_field "V3.3.0-v3.3.4 operational acceptance train" "$BASE_URL/api/experiments/operational-acceptance" "data.ok===true && data.schemaVersion==='experiments.operational-acceptance-train.v1' && data.sourceStatus==='pass' && ['pass','attention'].includes(data.localStatus) && data.externalStatus==='hold' && data.productionStatus==='blocked' && data.sourceSummary && data.sourceSummary.sourceOwnedSignals===4 && data.summary && data.summary.requiredVersions===5 && data.remediationExecutionPlan && data.remediationExecutionPlan.productionStatus==='blocked' && Array.isArray(data.versions) && data.versions.length===5 && data.versions.every((item)=>item.sourceSignal && ['pass','attention','unavailable','external-only'].includes(item.sourceSignal.status) && ['missing','invalid','verified'].includes(item.evidenceStatus) && item.checks.localProductionTransitionDenied===true)"
check_json_field "V3.4.0-v3.4.9 owner workload admission train" "$BASE_URL/api/experiments/owner-workload-admission" "data.ok===true && data.schemaVersion==='experiments.owner-workload-admission-train.v1' && data.sourceStatus==='pass' && ['pass','attention'].includes(data.localStatus) && data.externalStatus==='hold' && data.productionStatus==='blocked' && data.sourceSummary && data.sourceSummary.sourceOwnedSignals===9 && data.summary && data.summary.requiredVersions===10 && data.ownerWorkloadProtocol && data.ownerWorkloadProtocol.schemaVersion==='experiments.owner-workload-protocol.v1' && data.ownerWorkloadProtocol.summary.totalRequests===7 && data.ownerWorkloadProtocol.checks.everyActionBound===true && data.ownerWorkloadProtocol.checks.strictRequestDigests===true && data.ownerWorkloadProtocol.checks.remoteMutationDenied===true && data.ownerWorkloadProtocol.productionStatus==='blocked' && Array.isArray(data.versions) && data.versions.length===10 && data.versions.every((item)=>item.sourceSignal && ['pass','attention','unavailable','external-only'].includes(item.sourceSignal.status) && ['missing','invalid','verified'].includes(item.evidenceStatus) && item.checks.localProductionTransitionDenied===true)"
check_json_field "V3.5.0-v3.5.4 operational decision governance train" "$BASE_URL/api/experiments/operational-decision-governance" "data.ok===true && data.schemaVersion==='experiments.operational-decision-governance-train.v1' && data.sourceStatus==='pass' && ['pass','attention'].includes(data.localStatus) && data.externalStatus==='hold' && data.productionStatus==='blocked' && data.sourceSummary && data.sourceSummary.sourceOwnedSignals===4 && data.summary && data.summary.requiredVersions===5 && data.ownerWorkloadProtocol && data.ownerWorkloadProtocol.productionStatus==='blocked' && Array.isArray(data.versions) && data.versions.length===5 && data.versions.every((item)=>item.sourceSignal && ['pass','attention','unavailable','external-only'].includes(item.sourceSignal.status) && ['missing','invalid','verified'].includes(item.evidenceStatus) && item.checks.localProductionTransitionDenied===true)"
check_json_field "V3.6.0-v3.6.9 owner receipt lifecycle train" "$BASE_URL/api/experiments/owner-receipt-lifecycle" "data.ok===true && data.schemaVersion==='experiments.owner-receipt-intake-train.v1' && data.sourceStatus==='pass' && ['pass','attention'].includes(data.localStatus) && data.externalStatus==='hold' && data.productionStatus==='blocked' && data.sourceSummary && data.sourceSummary.sourceOwnedSignals===9 && data.summary && data.summary.requiredVersions===10 && data.ownerReceiptLifecycle && data.ownerReceiptLifecycle.schemaVersion==='experiments.owner-receipt-lifecycle.v1' && data.ownerReceiptLifecycle.productionStatus==='blocked' && data.ownerReceiptLifecycle.checks.eventChainValid===true && data.ownerReceiptLifecycle.checks.strictRevisionSequence===true && data.ownerReceiptLifecycle.checks.sensitivePayloadNotPersisted===true && Array.isArray(data.versions) && data.versions.length===10 && data.versions.every((item)=>item.sourceSignal && ['pass','attention','unavailable','external-only'].includes(item.sourceSignal.status) && ['missing','invalid','verified'].includes(item.evidenceStatus) && item.checks.localProductionTransitionDenied===true)"
check_json_field "V3.7.0-v3.7.4 operational exception lifecycle train" "$BASE_URL/api/experiments/operational-exception-lifecycle" "data.ok===true && data.schemaVersion==='experiments.operational-exception-lifecycle-train.v1' && data.sourceStatus==='pass' && ['pass','attention'].includes(data.localStatus) && data.externalStatus==='hold' && data.productionStatus==='blocked' && data.sourceSummary && data.sourceSummary.sourceOwnedSignals===4 && data.summary && data.summary.requiredVersions===5 && data.ownerReceiptLifecycle && data.ownerReceiptLifecycle.productionStatus==='blocked' && /^[a-f0-9]{64}$/.test(data.ownerReceiptLifecycle.decisionPackageDigest) && Array.isArray(data.versions) && data.versions.length===5 && data.versions.every((item)=>item.sourceSignal && ['pass','attention','unavailable','external-only'].includes(item.sourceSignal.status) && ['missing','invalid','verified'].includes(item.evidenceStatus) && item.checks.localProductionTransitionDenied===true)"
...
check_json_field "Experiments release train contract" "$BASE_URL/api/experiments/release-train" "data.ok===true && data.activeVersion==='v1.5.1' && data.developmentVersion==='v1.7.0-v3.7.4 source; v3.8.0-v3.9.4 planned' && Array.isArray(data.milestones) && data.milestones.length===200 && data.milestones.some((item)=>item.version==='v1.0.0' && item.status==='complete') && data.milestones.some((item)=>item.version==='v1.5.1' && item.status==='blocked') && data.milestones.some((item)=>item.version==='v1.6.7' && item.status==='complete') && data.milestones.some((item)=>item.version==='v1.6.8' && item.status==='complete') && data.milestones.some((item)=>item.version==='v1.6.9' && item.status==='complete') && data.milestones.some((item)=>item.version==='v1.7.0' && item.status==='active') && data.milestones.some((item)=>item.version==='v1.10.1' && item.status==='planned') && data.milestones.some((item)=>item.version==='v1.12.0' && item.status==='planned') && data.milestones.some((item)=>item.version==='v2.0.0' && item.status==='planned') && ['v2.0.1','v2.0.2','v2.0.3','v2.0.4','v2.0.5','v2.1.0','v2.1.1','v2.1.2','v2.1.3','v2.1.4','v2.1.5','v2.1.6','v2.1.7','v2.1.8','v2.1.9','v2.2.0','v2.2.1','v2.2.2','v2.2.3','v2.2.4','v2.2.5','v2.2.6','v2.2.7','v2.2.8','v2.2.9','v2.3.0','v2.3.1','v2.3.2','v2.3.3','v2.3.4','v2.4.0','v2.4.1','v2.4.2','v2.4.3','v2.4.4','v2.4.5','v2.4.6','v2.4.7','v2.4.8','v2.4.9','v2.5.0','v2.5.1','v2.5.2','v2.5.3','v2.5.4','v2.6.0','v2.6.1','v2.6.2','v2.6.3','v2.6.4','v2.6.5','v2.6.6','v2.6.7','v2.6.8','v2.6.9','v2.7.0','v2.7.1','v2.7.2','v2.7.3','v2.7.4','v2.8.0','v2.8.1','v2.8.2','v2.8.3','v2.8.4','v2.8.5','v2.8.6','v2.8.7','v2.8.8','v2.8.9','v2.9.0','v2.9.1','v2.9.2','v2.9.3','v2.9.4','v3.0.0','v3.0.1','v3.0.2','v3.0.3','v3.0.4','v3.0.5','v3.0.6','v3.0.7','v3.0.8','v3.0.9','v3.1.0','v3.1.1','v3.1.2','v3.1.3','v3.1.4','v3.2.0','v3.2.1','v3.2.2','v3.2.3','v3.2.4','v3.2.5','v3.2.6','v3.2.7','v3.2.8','v3.2.9','v3.3.0','v3.3.1','v3.3.2','v3.3.3','v3.3.4'].every((version)=>data.milestones.some((item)=>item.version===version && item.status==='evidence-needed')) && ['v3.4.0','v3.4.1','v3.4.2','v3.4.3','v3.4.4','v3.4.5','v3.4.6','v3.4.7','v3.4.8','v3.4.9','v3.5.0','v3.5.1','v3.5.2','v3.5.3','v3.5.4'].every((version)=>data.milestones.some((item)=>item.version===version && item.status==='evidence-needed')) && data.milestones.every((item)=>typeof item.version==='string' && Array.isArray(item.scope) && Array.isArray(item.acceptance) && Array.isArray(item.evidence))"
check_json_field "V3.6-v3.7 release train milestones" "$BASE_URL/api/experiments/release-train" "['v3.6.0','v3.6.1','v3.6.2','v3.6.3','v3.6.4','v3.6.5','v3.6.6','v3.6.7','v3.6.8','v3.6.9','v3.7.0','v3.7.1','v3.7.2','v3.7.3','v3.7.4'].every((version)=>data.milestones.some((item)=>item.version===version && item.status==='evidence-needed'))"
...
check_json_field "Experiments release evidence matrix contract" "$BASE_URL/api/experiments/release-evidence-matrix" "data.ok===true && data.schemaVersion==='experiments.release-evidence-matrix.v1' && data.activeVersion==='v1.5.1' && Array.isArray(data.rounds) && data.rounds.length===200 && data.totals && data.totals.roundCount===200 && data.totals.plannedCount>=34 && data.rounds.filter((round)=>/^v1\\.[1-5]\\./.test(round.version)).every((round)=>round.completionPct>0) && data.rounds.some((round)=>round.version==='v1.6.8' && round.status==='complete') && data.rounds.some((round)=>round.version==='v1.10.1' && round.status==='planned') && data.rounds.some((round)=>round.version==='v1.12.0' && round.status==='planned') && ['v2.0.1','v2.0.2','v2.0.3','v2.0.4','v2.0.5','v2.1.0','v2.1.1','v2.1.2','v2.1.3','v2.1.4','v2.1.5','v2.1.6','v2.1.7','v2.1.8','v2.1.9','v2.2.0','v2.2.1','v2.2.2','v2.2.3','v2.2.4','v2.2.5','v2.2.6','v2.2.7','v2.2.8','v2.2.9','v2.3.0','v2.3.1','v2.3.2','v2.3.3','v2.3.4','v2.4.0','v2.4.1','v2.4.2','v2.4.3','v2.4.4','v2.4.5','v2.4.6','v2.4.7','v2.4.8','v2.4.9','v2.5.0','v2.5.1','v2.5.2','v2.5.3','v2.5.4','v2.6.0','v2.6.1','v2.6.2','v2.6.3','v2.6.4','v2.6.5','v2.6.6','v2.6.7','v2.6.8','v2.6.9','v2.7.0','v2.7.1','v2.7.2','v2.7.3','v2.7.4','v2.8.0','v2.8.1','v2.8.2','v2.8.3','v2.8.4','v2.8.5','v2.8.6','v2.8.7','v2.8.8','v2.8.9','v2.9.0','v2.9.1','v2.9.2','v2.9.3','v2.9.4','v3.0.0','v3.0.1','v3.0.2','v3.0.3','v3.0.4','v3.0.5','v3.0.6','v3.0.7','v3.0.8','v3.0.9','v3.1.0','v3.1.1','v3.1.2','v3.1.3','v3.1.4','v3.2.0','v3.2.1','v3.2.2','v3.2.3','v3.2.4','v3.2.5','v3.2.6','v3.2.7','v3.2.8','v3.2.9','v3.3.0','v3.3.1','v3.3.2','v3.3.3','v3.3.4'].every((version)=>data.rounds.some((round)=>round.version===version && round.status==='evidence-needed')) && ['v3.4.0','v3.4.1','v3.4.2','v3.4.3','v3.4.4','v3.4.5','v3.4.6','v3.4.7','v3.4.8','v3.4.9','v3.5.0','v3.5.1','v3.5.2','v3.5.3','v3.5.4'].every((version)=>data.rounds.some((round)=>round.version===version && round.status==='evidence-needed')) && data.rounds.every((round)=>typeof round.version==='string' && typeof round.completionPct==='number' && Array.isArray(round.shipped) && Array.isArray(round.evidence) && Array.isArray(round.blockers) && Array.isArray(round.nextActions))"
check_json_field "V3.6-v3.7 release evidence matrix milestones" "$BASE_URL/api/experiments/release-evidence-matrix" "['v3.6.0','v3.6.1','v3.6.2','v3.6.3','v3.6.4','v3.6.5','v3.6.6','v3.6.7','v3.6.8','v3.6.9','v3.7.0','v3.7.1','v3.7.2','v3.7.3','v3.7.4'].every((version)=>data.rounds.some((round)=>round.version===version && round.status==='evidence-needed'))"
...
check_json_field "V3.8-v3.9 competitive product roadmap" "$BASE_URL/api/experiments/release-train" "['v3.8.0','v3.8.1','v3.8.2','v3.8.3','v3.8.4','v3.8.5','v3.8.6','v3.8.7','v3.8.8','v3.8.9','v3.9.0','v3.9.1','v3.9.2','v3.9.3','v3.9.4'].every((version)=>data.milestones.some((item)=>item.version===version && item.status==='planned'))"
check_json_field "V3.8-v3.9 competitive roadmap matrix" "$BASE_URL/api/experiments/release-evidence-matrix" "['v3.8.0','v3.8.1','v3.8.2','v3.8.3','v3.8.4','v3.8.5','v3.8.6','v3.8.7','v3.8.8','v3.8.9','v3.9.0','v3.9.1','v3.9.2','v3.9.3','v3.9.4'].every((version)=>data.rounds.some((round)=>round.version===version && round.status==='planned'))"
