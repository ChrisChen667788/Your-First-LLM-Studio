...
const response = await fetch(`${baseUrl}/api/experiments/v15-acceptance`, {
  method: "POST",
  headers: {
...
if (!response.ok || !payload.receipt) {
  throw new Error(payload.error || `v1.5 acceptance returned HTTP ${response.status}.`);
}

const evidence = {
  schemaVersion: "experiments.v15-acceptance-runner-evidence.v1",
