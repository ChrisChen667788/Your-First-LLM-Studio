...
const checks = [
  ...
  { id: "remediation-execution-api", path: "/api/experiments/remediation-execution", kind: "json", contract: "ok" },
  { id: "operational-acceptance-api", path: "/api/experiments/operational-acceptance", kind: "json", contract: "ok" },
  { id: "owner-workload-admission-api", path: "/api/experiments/owner-workload-admission", kind: "json", contract: "ok" },
  { id: "operational-decision-governance-api", path: "/api/experiments/operational-decision-governance", kind: "json", contract: "ok" },
  { id: "owner-receipt-lifecycle-api", path: "/api/experiments/owner-receipt-lifecycle", kind: "json", contract: "ok" },
  { id: "operational-exception-lifecycle-api", path: "/api/experiments/operational-exception-lifecycle", kind: "json", contract: "ok" },
