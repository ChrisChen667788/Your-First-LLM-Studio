...
| `v0.4` Current source checkpoint | Moves `/fine-tune`, `/compare`, `/models`, and `/benchmarks` into foreground product routes with feature-owned state/actions, dark-glass studio/workbench styling, thin API application wrappers, ModelScope/GitHub release packaging, and admin narrowed toward monitoring/configuration. |

Current tagged release: [`VERSION`](./VERSION). The source tree may contain the next route-owned refactor checkpoint before the next formal tag.
...
- Latest tagged release note: [v0.3.2](./docs/releases/v0.3.2_2026-05-18.md)
