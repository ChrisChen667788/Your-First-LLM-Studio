...
Release candidate notes: [`v1.1.0-rc.1`](./docs/releases/v1.1.0-rc.1_2026-07-16.md). The RC is locally package-complete and reproducible; it is not represented as notarized Apple distribution.
...
发布候选说明：[`v1.1.0-rc.1`](./docs/releases/v1.1.0-rc.1_2026-07-16.md)。该 RC 已完成本地打包和可复现验证，但不会被表述为 Apple 已公证正式分发包。
