...
function readReceipts(): Receipt[] { return readDurableReceipts(STORE_FILE, SERVER_SWITCH_CONTROLLER_SCHEMA_VERSION); }
function persist(receipt: Receipt) { prependDurableReceipt(STORE_FILE, SERVER_SWITCH_CONTROLLER_SCHEMA_VERSION, receipt, 100); }
