...
export function LocalServerAcceptancePanel() {
  ...
  return (
    <section
      id="local-server-live-acceptance"
      data-evidence-ready={Boolean(receipt)}
      className="border border-cyan-300/15 bg-slate-950/55 px-5 py-5 shadow-[0_20px_70px_rgba(2,6,23,0.24)]"
    >
