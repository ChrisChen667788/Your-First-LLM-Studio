...
export function RuntimeFabricEvidencePanel() {
  ...
  return (
    <section
      id="runtime-fabric-live-performance"
      data-evidence-ready={Boolean(receipt && promotion)}
      className="border border-sky-300/15 bg-slate-950/55 px-5 py-5 shadow-[0_20px_70px_rgba(2,6,23,0.24)]"
    >
