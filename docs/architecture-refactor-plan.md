...
1. Continue shrinking Agent layout composition and embedded Compare compatibility exports after v0.4.
2. Move remaining Admin benchmark-history and runtime rendering into governance feature panels.
3. Remove deprecated Admin API wrappers after the September 30, 2026 sunset if usage telemetry is clear.
4. Begin v0.4.1 experiment-history polish from the released v0.4.0 baseline.
